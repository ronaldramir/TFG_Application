...
# ------------------------------------------------------------
# === Crautos ULTRA-STABLE (EDGE + OPCIÓN A: tabs) ===
# - Edge WebDriver
# - Búsqueda por rango de años + solo usados
# - Recorre paginación completa
# - Por cada auto: abre detalle en pestaña nueva, extrae, cierra tab, vuelve a resultados (sin recargar)
# - Maneja 500 con reintentos + backoff
# - Checkpoint con last_page/last_idx para resume real
# - Auto-restart del driver sin perder progreso (+ hard kill en Windows)
